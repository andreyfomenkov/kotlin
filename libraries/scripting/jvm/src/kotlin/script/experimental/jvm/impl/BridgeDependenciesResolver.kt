...
import kotlin.script.experimental.jvm.defaultConfiguraion
...
class BridgeDependenciesResolver(
    ...
    val baseScriptCompilerConfiguration: ScriptCompileConfiguration = scriptConfigurator.defaultConfiguraion,
        ...
        return try {
            ...
            DependenciesResolver.ResolveResult.Success(
                ScriptDependencies(
                    ...
                    imports = refinedConfiguration.getOptional(ScriptCompileConfigurationParams.importedPackages)?.toList()
                            ?: emptyList()
                ),
                diagnostics
            )
